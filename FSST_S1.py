'''Feature set sensitivity test under the setting |S| = 1'''
...
def test_FSS(n=10**7, nr=7, net_path='./', diff=(0x0040, 0x0), folder='./bits_sensitive_res/'):
...
test_FSS(n=10**6, nr=7, net_path=net_path, diff=(0x0040, 0x0), folder=folder)